...
1. Is one of the teams or players from Canada?  If so, go for them.
2. Does one of the teams or players have any association or history supporting Donald Trump?  If so, pick the other team.
3. If neither team or player is from Candada or there's a tie between supporting/not supporting Trump (and his ilk), then ask if either is from California?  If so, pick them as California is pretty great.
4. If none of the above applies or is helpful go to the tie-breaker, which is simply to pick the team with the best colors and/or uniform design.
...
![blue_jays_logo]({{ "/assets/img/blog/2025-10-25-rooting-guide/blue_jays_logo.jpg" | relative_url }}){:width="100%"}
*Swoon*

![blue_jays_powder_blue]({{ "/assets/img/blog/2025-10-25-rooting-guide/blue_jays_powder_blue.jpg" | relative_url }}){:width="100%"}
