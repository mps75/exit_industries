...
It seems weird to work on a blog these days, but a few years ago I started to miss having a small web project like this.  I decided to scrap most of my old, stale blog and start something new.  I really enjoy fiddling with Jekyll and CSS and all the other pieces it takes to pull together a site (probably more than I like actually writing posts).  So it’s been fun to get something new up and running.  Plus, I'm kind of over social media at the moment and will hopefully use this to replace the doom-scrolling nightmare that's become.
